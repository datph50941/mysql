...
(1004, 3, 5),
(1005, 2, 1);
-- 1. Tổng doanh thu theo danh mục sản phẩm
SELECT 
    p.category,
...
-- 2. Danh sách người dùng và người giới thiệu (SELF JOIN)
SELECT 
    u.user_id,
    u.full_name,
...
-- 3. Sản phẩm đã từng được mua nhưng hiện tại không còn bán
...
-- 4. Người dùng chưa từng đặt hàng
...
-- 6. Tổng chi tiêu của mỗi người dùng (chỉ đơn hàng completed)
SELECT 
    o.user_id,
    u.full_name,
...
-- 8. Tổng số đơn hàng và tổng doanh thu theo thành phố
SELECT 
    u.city,
...
-- 11. UNION: Người từng đặt hàng và người được giới thiệu (không trùng)
